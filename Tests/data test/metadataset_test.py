...
class TestMetaDataset(TestCase):
    ...
    def test_union_metadataset(self):
        ...
        datasets = [Asome.data.MetaDataset(ds) for ds in datasets]
        union = Asome.data.UnionMetaDataset(datasets)
